...
import com.czf.utils.RedisUtil;
...
public class CachingShiroSessionDao extends CachingSessionDAO {
    ...
    public Session readSession(Serializable sessionId) throws UnknownSessionException {
        ...
        if (session == null
            ...
            if (session == null) {
                throw new UnknownSessionException("There is no sessino with id [" + sessionId + "]");
            } else {
                //缓存
    ...
    protected Session doReadSession(Serializable sessionId) {
        ...
        try {
            ...
            logger.info("sessionId {} name {} 被读取", session, session.getClass().getName());
        } catch (Exception e) {
