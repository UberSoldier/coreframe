...
import com.czf.base.utils.SerializeUtil;
...
public class RedisUtil {
    ...
    public static Object getObject(String key) throws Exception {
        Object object = null;
        try {
            String serializeObject = getString(key);
            if (null == serializeObject || serializeObject.length() == 0) {
                object = null;
            } else {
                object = SerializeUtil.deserialize(serializeObject);
            }
        } catch (Exception e) {
            throw e;
        }
