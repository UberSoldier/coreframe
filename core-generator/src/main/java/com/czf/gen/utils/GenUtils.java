...
import com.czf.base.utils.DateUtils;
import com.czf.base.utils.Utils;
import com.czf.gen.entity.ColumnEntity;
import com.czf.gen.entity.TableEntity;
...
public class GenUtils {
     ...
     * @param context
     */
    private static void webDown(ZipOutputStream zip, String template, TableEntity tableEntity, Template tpl, VelocityContext context) throws IOException {
     ...
     * @return
     */
    private static String getWebFileName(String template, String className, String aPackage) {
        String packagePath = "main" + File.separator + "java" + File.separator;
        if (StringUtils.isNotBlank(packagePath)) {
            packagePath += packagePath.replace(".", File.separator) + File.separator;
        }
        if (template.contains("Entity.java.vm")) {
        ...
        if (template.contains("Controller.java.vm")) {
            return packagePath + "c ntroller" + File.separator + className + "Controller.java";
        }
        if (template.contains("list.html.vm")) {
