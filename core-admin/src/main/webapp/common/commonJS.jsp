<script src="${webRoot}/static/js/jquery-2.0.3.min.js"></script>
<script src="${webRoot}/static/js/jquery-1.10.2.min.js"></script>
<script type="text/javascript">
    window.jQuery || document.write("<script src='${webRoot}/static/js/jquery-2.0.3.min.js'>" + "<" + "script>");
</script>
<script type="text/javascript">
    window.jQuery || document.write("<script src='${webRoot}/static/js/jquery-1.10.2.min.js'>" + "<" + "script>");
</script>
<script type="text/javascript">
    if ("ontouchend" in document) document.write("<script src='${webRoot}/static/js/jquery.mobile.custom.min.js'>" + "<" + "script>");
</script>
<script>
	var webRoot  =  "${webRoot}";
</script>
<script src="${webRoot}/static/js/html5shiv.js"></script>
<script src="${webRoot}/static/js/respond.min.js"></script>
<script src="${webRoot}/static/js/typeahead-bs2.min.js"></script><%--自动完成 AutoComplete--%>
<script type="text/javascript" src="${webRoot}/static/js/chosen.jquery.min.js"></script> <%--标签进行级联--%>
<script type="text/javascript" src="${webRoot}/static/js/select2.min.js"></script> <%--下框插件--%>
...
<script type="text/javascript" src="${webRoot}/static/plugins/layui/lay/modules/form.js"></script>
<script type="text/javascript" src="${webRoot}/static/plugins/layui/lay/modules/element.js"></script>
<script type="text/javascript" src="${webRoot}/static/plugins/layer/mylayer.js"></script>
<script type="text/javascript" src="${webRoot}/static/js/bootstrap.min.js"></script>
<script type="text/javascript" src="${webRoot}/static/plugins/validator/js/bootstrapValidator.js"></script> <%--前端验证bootstrapValidator--%>
<script type="text/javascript" src="${webRoot}/static/plugins/ztree/jquery.ztree.all.min.js"></script><%--ztree树结构--%>
<script type="text/javascript" src="${webRoot}/static/plugins/validform/js/Validform_v5.3.2.js"></script> <%--前端表单验证validform--%>
<script>
