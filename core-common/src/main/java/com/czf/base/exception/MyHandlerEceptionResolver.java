package com.czf.base.exception;

import com.alibaba.druid.support.json.JSONUtils;
import com.czf.base.utils.JsonUtil;
import com.czf.base.utils.Result;
import com.czf.base.utils.WebUtils;
 ...
 */
public class MyHandlerEceptionResolver implements HandlerExceptionResolver {

    private static Logger logger = LoggerFactory.getLogger(MyHandlerEceptionResolver.class);
    ...
    public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object o, Exception e) {
        ...
        if (WebUtils.isAjax(request)) {
            ...
            //这里需要手动将异常打印出来，由于没有设置log，实际生产环境应该打印到log里面
            e.printStackTrace();
